// Auto-generado desde alivia-system.es.md (que vive como fuente leíble en docs).
// Inlinado como string para que el bundle de wasp build lo embeba.
// Si actualizas la voz de Alivia, edita el .md (fuente de verdad para revisión
// humana) y luego corre: node scripts/sync-prompt.mjs

export const ALIVIA_SYSTEM_PROMPT = `
